...
package com.ebay.chrysan.samples.searchapi.error;

import com.ebay.chrysan.samples.searchapi.http.HttpStatus;
import com.ebay.chrysan.samples.searchapi.util.ObjectUtils;
...
public class RestError {
    ...
    private static final String DEFAULT_MORE_INFO_URL = "mailto:support@ebay.chrysan.com";
