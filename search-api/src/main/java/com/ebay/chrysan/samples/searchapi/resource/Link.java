...
package com.ebay.chrysan.samples.searchapi.resource;

import com.ebay.chrysan.samples.searchapi.entity.Entity;
...
public class Link extends LinkedHashMap {
    private static final String SERIALIZER_PACKAGE_NAME = "com.ebay.chrysan.samples.searchapi.entity";
