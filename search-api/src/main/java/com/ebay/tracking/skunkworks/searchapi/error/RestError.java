...
package com.ebay.tracking.skunkworks.searchapi.error;

import com.ebay.tracking.skunkworks.searchapi.http.HttpStatus;
import com.ebay.tracking.skunkworks.searchapi.util.ObjectUtils;
...
public class RestError {
    ...
    private static final String DEFAULT_MORE_INFO_URL = "mailto:chrysan@ebay.com";
